...
class Android(PlatformDirsABC):
    ...
    def user_config_dir(self) -> str:
        """
        :return: configu.py directory tied to the user, e.g. ``/data/user/<userid>/<packagename>/shared_prefs/<AppName>``
        """
        return self._append_app_name_and_version(_android_folder(), "shared_prefs")

    @property
    def site_config_dir(self) -> str:
        """:return: configu.py directory shared by the users, same as `user_config_dir`"""
